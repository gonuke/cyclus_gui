...
from cyclus_gui.tools.templates import template_collections
...
def region_render(reactor_data):
    ...
    for country in country_set:
        if len(reactor_data) == 0:
            print('Country %s has no reactors over the limit' %country)
            continue
        prototype = ''
        entry_time = ''
        n_build = ''
